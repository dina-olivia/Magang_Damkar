...
// Ensure $conn is defined by the included file
if (!isset($conn)) {
    die("Error: database connection \$conn is not defined. Check config/koneksi.php");
}
                ...
                <div class="col-6 col-md-4 col-lg-2-4">
                    <div class="stat-card-new">
                        ...
                        <div>
                            ...
                            <div class="value" style="color:#ef4444;"><?= $proses['t'] ?></div>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-md-4 col-lg-2-4">
                    <div class="stat-card-new">
                        ...
                        <div>
                            ...
                            <div class="value" style="color:#16a34a;"><?= $selesai['t'] ?></div>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-md-4 col-lg-2-4">
                    <div class="stat-card-new">
                        ...
                        <div>
                            ...
                            <div class="value" style="color:#2563eb;"><?= $armada['t'] ?></div>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-md-4 col-lg-2-4">
