...
<head>
    ...
    <style>
        ...
        .hero-info {
            background: linear-gradient(135deg, #a00428 0%, #457b9d 100%);
            color: white;
            padding: 40px;
        }
            ...
            <div class="row g-4">
                    ...
                    <div class="card-main mb-4">
                        <div class="hero-info">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <span class="badge bg-white text-primary mb-2 rounded-pill px-3 py-2 fw-bold"
                        ...
                        <div class="card-body p-4 p-md-5">
                            <div class="row g-4 mb-4">
                                <div class="col-md-4">
                                    <div class="info-grid">
                                        <small class="text-muted d-block mb-1 text-uppercase fw-bold"
                                            style="font-size: 0.65rem;">Pelapor</small>
                                ...
                                <div class="col-md-4">
                                    <div class="info-grid">
                                        <small class="text-muted d-block mb-1 text-uppercase fw-bold"
                                            style="font-size: 0.65rem;">Lokasi TKP</small>
                                ...
                                <div class="col-md-4">
                                    <div class="info-grid">
                                        <small class="text-muted d-block mb-1 text-uppercase fw-bold"
                                            style="font-size: 0.65rem;">Tanggal Kejadian</small>
                            ...
                            <div class="p-4 rounded-4" style="background: #fff5f5; border: 1px dashed #fecaca;">
                                <h6 class="fw-bold text-danger mb-2"><i
                                        class="bi bi-chat-square-text-fill me-2"></i>Deskripsi Kronologi</h6>
                ...
                <div class="col-lg-4">
                    <div class="card-main p-4">
                        ...
                        <div class="timeline" id="timeline-container" data-jam="<?= $jam_dasar ?>"
                            data-menit="<?= $menit_dasar ?>" data-status="<?= $status ?>">
                            ...
                            <div class="timeline-item">
                                <div
                                    class="timeline-marker <?= ($status == 'proses' || $status == 'selesai') ? 'marker-active' : '' ?>">
                                </div>
