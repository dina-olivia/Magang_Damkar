...
<head>
    ...
    <style>
        :root { --primary-red: #dc3545; --soft-bg: #f4f7f6; }
        body { background-color: var(--soft-bg); font-family: 'Segoe UI', sans-serif; }
        .main-content { margin-left: 280px; transition: 0.3s; }
        .form-card { background: white; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.05); overflow: hidden; border: none; }
        .card-header-gradient { background: linear-gradient(135deg, var(--primary-red), #ff4d5a); padding: 25px; color: white; }
        .form-label { font-size: 0.85rem; font-weight: 600; color: #64748b; margin-bottom: 8px; }
        .form-control, .form-select { border-radius: 12px; padding: 12px; border: 1px solid #e2e8f0; background-color: #f8fafc; transition: 0.3s; }
        .form-control:focus { border-color: var(--primary-red); box-shadow: 0 0 0 0.25rem rgba(220, 53, 69, 0.1); outline: none; }
        .section-title { font-size: 0.9rem; text-transform: uppercase; letter-spacing: 1px; color: var(--primary-red); border-left: 4px solid var(--primary-red); padding-left: 10px; margin: 30px 0 20px 0; font-weight: bold; }
        .btn-save { background: var(--primary-red); border: none; padding: 12px 35px; border-radius: 12px; font-weight: 700; transition: 0.3s; color: white; }
        .btn-save:hover { transform: translateY(-3px); box-shadow: 0 5px 15px rgba(220, 53, 69, 0.3); background: #c82333; color: white; }
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="nomor_laporan" class="form-control fw-bold text-danger" value="<?= $no_lp_baru ?>" readonly>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">Waktu Kejadian</label>
                                    <input type="datetime-local" name="tanggal" id="waktu_kejadian" class="form-control" required>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="pelapor" class="form-control" placeholder="Nama Lengkap Pelapor" required>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-12 mt-3">
                                    ...
                                    <input type="text" name="lokasi" class="form-control" placeholder="Contoh: Jl. Merdeka No. 10, RT 01/RW 02..." required>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <textarea name="deskripsi" class="form-control" rows="5" placeholder="Tuliskan deskripsi singkat kejadian di sini..."></textarea>
                                </div>
                            </div>

                            <div class="d-flex justify-content-end gap-3 mt-5">
                                <a href="monitoring_kejadian.php" class="btn btn-light px-4 border rounded-pill">Batal</a>
